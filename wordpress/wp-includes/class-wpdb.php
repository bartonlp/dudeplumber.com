...
class wpdb {
	 ...
	 *
	 * Use esc_query() or wpdb::prepare() instead.
	 *
	 * @since 2.8.0
	...
	public function _weak_escape( $data ) {
		if ( func_num_args() === 1 && function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __METHOD__, '3.6.0', 'wpdb::prepare() or esc_query()' );
		}
	 ...
	 *
	 * Use this only before wpdb::prepare() or esc_query(). Reversing the order is very bad for security.
	 *
	 ...
	 *
	 *     $sql  = esc_query( $wpdb->esc_like( $input ) );
	 *
	 * @since 4.0.0
	 *
