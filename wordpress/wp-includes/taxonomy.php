 ...
 * @return string[]
 */
function get_tax_query( $tax_query, $primary_table, $primary_id_column ) {
	$tax_query_obj = new WP_Tax_Query( $tax_query );
	return $tax_query_obj->get_query( $primary_table, $primary_id_column );
}
...
function _pad_term_counts( &$terms, $taxonomy ) {
	...
	$object_types = esc_query( $tax_obj->object_type );
...
function _update_post_term_count( $terms, $taxonomy ) {
	...
	if ( $object_types ) {
		$object_types = esc_query( array_filter( $object_types, 'post_type_exists' ) );
	}
	 ...
	 */
	$post_statuses = esc_query( apply_filters( 'update_post_term_count_statuses', $post_statuses, $taxonomy ) );
