...
class WP_Term_Query {
	...
	public function get_terms() {
		...
		if ( ! empty( $args['search'] ) ) {
			$this->sql_clauses['where']['search'] = $this->get_search_query( $args['search'] );
		}
		...
		$mq_sql       = $this->meta_query->get_query( 'term', 't', 'term_id' );
	...
	protected function parse_orderby_meta( $orderby_raw ) {
		...
		$this->meta_query->get_query( 'term', 't', 'term_id' );
		$meta_clauses = $this->meta_query->get_clauses();
