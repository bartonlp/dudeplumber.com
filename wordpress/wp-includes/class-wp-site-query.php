...
class WP_Site_Query {
	...
	public function get_sites() {
		...
		if ( ! empty( $this->meta_query->queries ) ) {
			$this->meta_query_clauses = $this->meta_query->get_query( 'blog', $wpdb->blogs, 'blog_id', $this );
		}
	...
	protected function get_site_ids() {
		...
		if ( strlen( $this->query_vars['search'] ) ) {
			...
			$this->sql_clauses['where']['search'] = $this->get_search_query( $this->query_vars['search'], $search_columns );
		}
