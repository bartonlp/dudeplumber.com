...
class WP_Date_Query {
	...
	public function __construct( $date_query, $default_column = 'post_date' ) {
		...
		if ( ! empty( $date_query['column'] ) ) {
			$date_query['column'] = esc_query( $date_query['column'] );
		} else {
			$date_query['column'] = esc_query( $default_column );
		}
	 ...
	 *
	 * Called by the public WP_Date_Query::get_query(), this method is abstracted
	...
	protected function get_sql_for_clause( $query, $parent_query ) {
		...
		$column = ( ! empty( $query['column'] ) ) ? esc_query( $query['column'] ) : $this->column;
