...
function get_page_by_path( $page_path, $output = OBJECT, $post_type = 'page' ) {
	...
	$post_types          = esc_query( $post_types );
 ...
 */
function get_private_posts_cap_query( $post_type ) {
	return get_posts_by_author_query( $post_type, false );
}
 ...
 *
 * @see get_private_posts_cap_query()
 * @global wpdb $wpdb WordPress database abstraction object.
 *
 ...
 */
function get_posts_by_author_query( $post_type, $full = true, $post_author = null, $public_only = false ) {
	global $wpdb;
