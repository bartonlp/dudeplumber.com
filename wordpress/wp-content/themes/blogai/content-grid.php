...
?>
    ...
    <div id="post-<?php the_ID(); ?>" <?php if($blogai_content_layout == "grid-right-sidebar") { echo post_class('col-md-4'); } else { echo post_class('col-md-6'); } ?>>
            ...
            <div class="bs-blog-post"> 
                ...
                <article class="small">
                    ...
                    <?php blogus_post_meta(); ?>
                            <?php $blogai_content_layout = get_theme_mod('blogus_blog_content', 'excerpt'); 
                            if($blogai_content_layout == 'excerpt')
                            {
                            ?>
